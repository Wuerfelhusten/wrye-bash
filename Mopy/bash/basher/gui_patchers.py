...
class _ListsMergerPanel(_ChoiceMenuMixin, _ListPatcherPanel):
    ...
    def _auto_layout(self, right_side_components=None):
        ...
        self._add_rem_bt = [Button(self, _('Add'), on_click=self.OnAdd),
                            Button(self, _('Remove'), on_click=self.OnRemove)]
    ...
    def saveConfig(self, configs):
        ...
        for att, _ in self._config_atts: config[att] = getattr(self, att)
        return config
